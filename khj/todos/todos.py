...
class Todos :
    ...
    # 데이터 추가
    @classmethod
    def insert_todo(cls, userId, title, completed):
        save_query = "insert into tbl_todos(userId, title, completed) values (%s, %s, %s)"
        save_params = (userId, title, completed)
...
if __name__ == '__main__':
    # 데이터 추가
    # Todos.insert_todo(10, "추가된 제목", False)
    ...
    # 조회하기
    # Todos.read_select_todo(1)

    # 수정하기
    # Todos.update_todo(todo_id=1, new_title="수정된 제목")

    # 삭제하기
    # Todos.delete_todo(todo_id=200)
